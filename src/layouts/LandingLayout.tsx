      ...
      <footer className='bg-gray-900 py-12 text-white'>
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4'>
            <div>
              <h3 className='mb-4 text-xl font-bold'>SkillLink</h3>
              <p className='mb-4 text-gray-400'>
                Conectando desarrolladores con mentores expertos para impulsar
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg
                        ...
                        aria-hidden='true'>
                        <path
                          d='M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 
                    ...
                    icon: (
                      <svg
                        ...
                        <path
                          ...
                          0 .268.18.58.688.482A10.019 10.019 0 
